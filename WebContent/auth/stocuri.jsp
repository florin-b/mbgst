	...
	<div data-role="page" id="stocuri" data-theme="a" data-url="">
		...
		<div data-role="content" class="ui-content">
			...
			<div class="ui-grid-a">
				...
				<div class="ui-block-b" id='stocResult'>
		
					<div> 
					<div id='numeArtSel'></div>
					<br>
					<table data-role="table" id="stoc-table" data-mode="reflow"
						class="ui-responsive table-stroke">
						<thead>
							<tr>
								<th data-priority="1">Cantitate</th>
								<th data-priority="2">Um</th>
								<th data-priority="3">Depozit</th>
							</tr>
						</thead>
						<tbody id='stocuriArticol'>
						</tbody>
					</table>
